...
Los pasos siguientes de esta fase (conectar el Context Builder al panel del Copilot, elegir proveedor de IA, diseñar el prompt) requieren su propia especificación (Product/UI/Technical Spec + criterios de aceptación) antes de implementarse.
